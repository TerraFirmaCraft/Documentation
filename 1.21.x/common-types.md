...
- [Sized Fluid Ingredients](#sized-fluid-ingredients)
...
## Sized Fluid Ingredients

A sized fluid ingredient is a combination of a fluid ingredient with an amount. It has the fields of a Fluid Ingredient with an added count.
...
```jsonc
// A sized fluid ingredient which matches at least 25mB of brown dye
{
    "amount": 25,
    "fluid": "tfc:brown_dye"
}
...
- `id`: String. The registry name of the item in the stack.
- `count`: An optional Integer (Default: `1`). The count of the item stack.
- `components`: An optional object representing component data to be added to the item stack.
